...
| `--index-path <index_path>` | `opts.index_path`    | `bids2table` index path - default: `{bids_dir}/index.parquet`                                                                   |
...
> [!NOTE]
> Most options are reused across multiple non-index stages. For stage-specific options,
> please refer to the [Analysis stages](./analysis_levels/) pages.
